"""
generator.bom — write_bom() with complete ESP32-P4 BOM entries.

Writes hardware/bom/bom.csv with all components for the PoE FanController.
"""
...
def write_bom():
    ...
    rows = [
        ...
        ["R15","6k04","Resistor_SMD:R_0402_1005Metric","1","Yageo","RC0402FR-076K04L","6.04kΩ 1% 0402 — LAN8720A RBIAS (internal bias current set)","https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_12.pdf"],
