...
def write_bom():
    ...
    rows = [
        ...
        ["R5,R6,R7,R8","10k","Resistor_SMD:R_0805_2012Metric","4","Yageo","RC0805FR-0710KL","10kΩ 0805 1% — fan TACH pull-up resistors (3.3V from J8)","https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_12.pdf"],
        # Per-fan Power Indicator LEDs (passive: +12V → R → LED → GND)
        ["R9,R10,R11,R12","1k","Resistor_SMD:R_0805_2012Metric","4","Yageo","RC0805FR-071KL","1kΩ 0805 1% — per-fan LED current limiting resistors","https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_12.pdf"],
        ...
        # Temperature Sensing
        ["R4","10k","Resistor_SMD:R_0805_2012Metric","1","Yageo","RC0805FR-0710KL","10kΩ 0805 1% — NTC divider pull-up (3.3V from J8)","https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_12.pdf"],
        ...
        ["R3","330R","Resistor_SMD:R_0805_2012Metric","1","Yageo","RC0805FR-07330RL","330Ω 0805 1% — status LED current limit","https://www.yageo.com/upload/media/product/productsearch/datasheet/rchip/PYu-RC_Group_51_RoHS_L_12.pdf"],
