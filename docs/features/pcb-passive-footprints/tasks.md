...
### T001: Run ERC gate on current schematic
...
### T002: Add Zone A SMD passives to generator (R5–R8)
...
### T003: Add Zone B SMD passives to generator (R1–R4, C3–C6)
...
### T004: Add Zone C SMD passives to generator (C7, R9, R10)
...
### T005: Add Zone C THT components to generator (SW1, SW2, LED1, NTC1)
...
### T006: DRC gate — missing_footprint=0, total violations ≤36
...
### T007: Update BOM with MPNs for all 19 new components
...
### T008: Final DRC gate and regenerate Gerbers
